...
public class CamelRabbitmqSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_RABBITMQ_ENDPOINT_ROUTING_KEY_DOC = "The routing key to use when binding a consumer queue to the exchange. For producer routing keys, you set the header CamelRabbitmqRoutingKey.";
    ...
    public static final String CAMEL_SINK_RABBITMQ_ENDPOINT_BRIDGE_ENDPOINT_DOC = "If the bridgeEndpoint is true, the producer will ignore the message header of CamelRabbitmqExchangeName and CamelRabbitmqRoutingKey";
    ...
    public static final String CAMEL_SINK_RABBITMQ_ENDPOINT_MANDATORY_DOC = "This flag tells the server how to react if the message cannot be routed to a queue. If this flag is set, the server will return an unroutable message with a Return method. If this flag is zero, the server silently drops the message. If the header is present CamelRabbitmqMandatory it will override this option.";
    ...
    public static final String CAMEL_SINK_RABBITMQ_COMPONENT_MANDATORY_DOC = "This flag tells the server how to react if the message cannot be routed to a queue. If this flag is set, the server will return an unroutable message with a Return method. If this flag is zero, the server silently drops the message. If the header is present CamelRabbitmqMandatory it will override this option.";
